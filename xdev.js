...
offline = false
targetpc = '0'
ownerNumber = ["6283192610828@s.whatsapp.net"]
fake = 'CREATED BY INDRA\n© SMARTBOT'
fake1 = 'SMARTBOT'
numbernye = '0'
waktu = '-'
alasan = '-'
...
module.exports = xdev = async (xdev, dev) => {
	try {
        ...
        //FAKEREPLY PRODUCT
            ...
            //FAKEREPLY VIDEO
            const fvideo = {
                  key: {fromMe: false,participant: `6283192610828@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '-99999', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
            //FAKEREPLY GROUPINVITE
            const fgc = {
                  key: {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6283192610828-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `${fake}`, 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
            //FAKEREPLY GIF
            const fgif = {
                  key: {fromMe: false,participant: `6283192610828@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}} 
...
pic = 'https://i.ibb.co/BnPNk8D/IMG-20210727-WA0031.png'
}
...
gbutsan = [
  ...
  {buttonId: 'RULES BOT', buttonText: {displayText: 'RULES BOT'}, type: 1},
...
xdev.sendMessage(from,'Nih Kak Creator SMARTBOT',text,{quoted: hehe})
break
case 'style':
      ...
      xdev.sendMessage(from, hasil, MessageType.text, { quoted: dev});
			...
			break
case 'pastebin':
if(!q) return reply(`Example : SMARTBOT`)
...
xdev.sendMessage(from, `*── 「 PRICE LIST 」 ──*\n \n*Sewa SMARTBOT*\n*Keuntungan Sewa Diantaranya:*\n♲ *Bisa Dimasukan Ke Grup Anda*\n♲ *Dapat Informasi Lebih dulu akan Update, Nomor Bot Baru (Jika Terbanned), dan Lainnya*\n*Jika Tertarik,Kalian Bisa Bayar Melalui Metode Pembayaran di Bawah:*\n*Dana : 083192610828*\n*Gopay : 083192610828*\n*Gopay : 083192610828*\n*OVO : 083192610828 atau melalui Qris*\n \n*= Rp. 20.000 /PERBULAN*\n*= Rp. 50.000 /PERMANEN*\n \nDi Sponsori Oleh *@0*\n*Info Lebih Lengkap Chat Owner, Ketik !owner*\n*_note_*:\n*Sewa Bot Pada Tanggal 17 Agustus Cuma Rp.17.000 ( Spesial HUT RI KE-76 )*`, text, {quoted: dev})
}
if (button == 'RULES BOT') {
console.log('RULES BOT')
xdev.sendMessage(from, `*RULES BOT*\n \n1. Jangan spam bot. \nSanksi: *WARN/SOFT BLOCK*\n2. Jangan telepon bot.\nSanksi: *SOFT BLOCK*\n \n3. Jangan mengejek bot.\nSanksi: *PERMANENT BLOCK*\n \n3. Gpp sc gw jelek yg penting \nBot gw jalan awokawoak\nJika sudah dipahami rules-nya, silakan ketik *!menu* untuk memulai!\n \n*Jika ingin Sc ini harap hubungi owner kami*\n \nOwner SMARTBOT:\nwa.me/6283192610828`, text, {"contextInfo": {text: 'HelloWorld',"forwardingScore": 3,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hallo kak ${pushname}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://telegra.ph/file/c6990a64b71687dc1157e.jpg`,"thumbnail": "","sourceUrl": ""}}, quoted: dev})
}
if (budy.startsWith('$')){
if (!dev.key.fromMe && !isOwner) return
qur = budy.slice(2)
exec(qur, (err, stdout) => {
if (err) return reply(`@Rion SMARTBOT:~ ${err}`)
if (stdout) {
reply(stdout)
}
})
